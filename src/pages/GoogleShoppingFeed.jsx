...
const T = {
  en: {
    ...
    stats: [
      ...
      { v: '176', l: 'merchants with live campaigns' },
    ],
    ...
    whoText: ['CatyAI is operated by the team behind the PayAI-x Comparison Shopping Service, running live Google Shopping campaigns for ', '176 merchants', '. The pipeline was built to solve our own feed-quality problems first — the tooling is the byproduct of operating a CSS, not the other way around.'],
  ...
  ro: {
    ...
    stats: [
      ...
      { v: '176', l: 'comercianți cu campanii live' },
    ],
    ...
    whoText: ['CatyAI este operat de echipa din spatele serviciului de comparare prețuri (CSS) PayAI-x, cu campanii Google Shopping live pentru ', '176 de comercianți', '. Pipeline-ul a fost construit mai întâi pentru a ne rezolva propriile probleme de calitate a feed-ului — toolingul este un produs secundar al operării unui CSS, nu invers.'],
  ...
  es: {
    ...
    stats: [
      ...
      { v: '176', l: 'comerciantes con campañas activas' },
    ],
  ...
  pt: {
    ...
    stats: [
      ...
      { v: '176', l: 'comerciantes com campanhas ativas' },
    ],
  ...
  fr: {
    ...
    stats: [
      ...
      { v: '176', l: 'marchands avec campagnes actives' },
    ],
