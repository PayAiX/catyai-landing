...
const translations = {
  ro: {
    ...
    heroPlaceholder: 'https://magazinul-tau.ro/feed.xml', heroBtn: 'Verifică gratuit',
  ...
  en: {
    ...
    heroPlaceholder: 'https://your-store.com/feed.xml', heroBtn: 'Check free',
  ...
  es: {
    ...
    heroPlaceholder: 'https://tu-tienda.com/feed.xml', heroBtn: 'Verificar gratis',
  ...
  pt: {
    ...
    heroPlaceholder: 'https://sua-loja.com/feed.xml', heroBtn: 'Verificar grátis',
  ...
  fr: {
    ...
    heroPlaceholder: 'https://votre-boutique.fr/feed.xml', heroBtn: 'Vérifier gratuitement',
