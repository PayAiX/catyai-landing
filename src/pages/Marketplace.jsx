...
const translations = {
  ro: {
    ...
    stat1N: '1.171.877', stat1L: 'produse indexate în Agentic Marketplace', stat1T: 'LIVE pe shop.catyai.io',
    ...
    finalSub: 'Vezi marketplace-ul live cu 1,1M produse, sau programează direct o discuție de parteneriat.',
  ...
  en: {
    ...
    stat1N: '1,171,877', stat1L: 'products indexed in the Agentic Marketplace', stat1T: 'LIVE on shop.catyai.io',
    ...
    earnBody: 'Our own marketplace — shop.catyai.io — runs on the same affiliate commissions your catalog will generate: 1,171,877 products · 21 partner merchants · 1% to 20% commission per transaction, brought organically by AI agents, with zero ad spend (Zero-CAC). We install for you the very infrastructure we run ourselves, in production, every day.',
    ...
    finalSub: 'See the live marketplace with 1.1M products, or book a partnership call directly.',
