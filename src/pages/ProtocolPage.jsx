...
export default function ProtocolPage() {
  ...
  return (
    <>
      <SEO
        title="NAP V3 Protocol — Native AI Protocol by CatyAI"
        description="Open protocol for AI crawler discovery. NAP V3 + AKL v2 transforms your business data into cryptographically signed, AI-native endpoints indexed by GPT, Gemini, Claude, and Perplexity."
      ...
      <style>{`
        ...
        .np-endpoint-card-header {
          display: flex;
          align-items: center;
          gap: 0.6rem;
          margin-bottom: 0.6rem;
        }
        .np-endpoint-card-dot {
          width: 8px; height: 8px; border-radius: 50%;
          background: #22c55e;
          box-shadow: 0 0 8px rgba(34,197,94,0.5);
          flex-shrink: 0;
        }
        .np-endpoint-card-path {
          font-family: monospace;
          font-size: 0.8rem;
          color: #C8A165;
          letter-spacing: 0.04em;
        }
        .np-endpoint-card-desc {
          font-size: 0.88rem;
          color: #64748b;
          line-height: 1.5;
        }
      ...
      <div className="np-page">
          ...
          <div className="np-hero-inner">
            <div>
              <div className="np-badge-row">
                <span className="np-badge">⬡ NAP V3</span>
                <span className="np-badge">AKL v2</span>
                <span className="np-badge np-badge-anthropic">✦ Anthropic Claude Partner Network</span>
              </div>
              <h1 className="np-hero-title">
                Native AI Protocol<br />
                <span>V3 Specification.</span>
              </h1>
              <p className="np-hero-sub">
                NAP V3 + AKL v2 transform your business data into cryptographically signed, AI-native endpoints — verified by Ed25519, discovered via /.well-known/ai-context, and indexed natively by GPT, Gemini, Claude, and Perplexity.
              </p>
              <div className="np-cta-row">
                <a href="https://app.catyai.io/register" className="np-cta-primary">Deploy NAP Protocol</a>
                <Link to="/platform" className="np-cta-secondary">View Platform Architecture →</Link>
              </div>
            </div>
        ...
        <section className="np-section">
          <div className="np-container">
            <div className="np-section-label">Protocol Stack</div>
            <h2 className="np-section-title">Four Layers of<br />AI-Native Authority</h2>
            <p className="np-section-sub">
              NAP V3 is not a plugin. It is a foundational infrastructure specification that makes your business data verifiable, structured, cryptographically signed, and continuously synchronized with every major AI model.
            </p>
            <div className="np-steps">
              {PROTOCOL_LAYERS.map((s) => (
        ...
        <section className="np-section-alt">
          <div className="np-container">
            <div className="np-wk-grid">
              <div>
                <div className="np-section-label">Live Endpoints</div>
                <h2 className="np-wk-title">Public discovery<br />endpoints.</h2>
                <p className="np-wk-sub">
                  CatyAI's own infrastructure implements the full NAP V3 spec. Both endpoints are live, publicly accessible, and signed with our Ed25519 key pair. Use them to verify the protocol works before deploying for your business.
                </p>
                <ul className="np-feature-list">
                  <li>ai-context returns full JSON-LD business identity</li>
                  <li>jwks.json exposes the Ed25519 public key for verification</li>
                  <li>Both endpoints are RFC 8615 well-known compliant</li>
                  <li>Signed payloads verifiable by any JOSE-compliant client</li>
                  <li>Zero authentication required for public discovery</li>
                </ul>
              </div>
              <div className="np-endpoint-cards">
                ...
                <div className="np-code-block">
                  <div className="np-code-header">
                    ...
                    <span className="np-code-title">Verify EdDSA signature</span>
                  </div>
...
jose verify --jwks jwks.json payload.json`}</div>
        ...
        <section className="np-cta-section">
          <div className="np-section-label" style={{ marginBottom: '1.2rem' }}>Get Started</div>
          <h2 className="np-cta-title">Your business,<br />native to every AI.</h2>
          ...
          <div className="np-cta-btns">
            <a href="https://app.catyai.io/register" className="np-cta-primary">Start Free Trial</a>
            <Link to="/contact" className="np-cta-secondary">Talk to Sales →</Link>
          </div>
        </section>
