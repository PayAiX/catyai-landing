        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4">
            {features.map((feature, i) => (
              <div
                key={i}
                className={`flex items-start gap-4 p-5 bg-gray-800/40 rounded-xl border border-gray-700/50 transition-all duration-500 hover:border-green-500/30 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`}
          ...
          <div className={`transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
            ...
            <div className="relative mx-auto max-w-xs mb-8">
              <div className="bg-gray-800 rounded-[2.5rem] p-2 shadow-2xl border border-gray-700">
                <div className="bg-gray-900 rounded-[2rem] overflow-hidden">
                  ...
                  <div className="bg-[#0b141a] p-3 min-h-[220px] space-y-2">
                    <div className="flex justify-start">
                      <div className="bg-gray-800 rounded-xl rounded-tl-none px-3 py-2 max-w-[85%]">
            ...
            <div className="text-center space-y-4">
              <a
                ...
                className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold text-lg rounded-2xl hover:opacity-90 transition-all shadow-lg shadow-green-500/25 hover:shadow-green-500/40 hover:scale-[1.02]"
              >
              ...
              <div>
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-gray-800 hover:bg-gray-700 text-white font-semibold rounded-xl transition-all border border-gray-700"
                >
